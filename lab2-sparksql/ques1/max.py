...
max_temperatures = max_temperatures.join(schemaTempReadings, ['year', 'value']).select ('year','station','value').orderBy(F.desc("value"))


# Following code will save the result into /user/ACCOUNT_NAME/BDA/output folder
max_temperatures.rdd.saveAsTextFile("BDA/output")
#min_temperatures.rdd.saveAsTextFile("BDA/output/min")
